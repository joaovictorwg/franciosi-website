...
SECRET_KEY = 'django-insecure-uu!7#iw1m!@poc!j5esy05)4si4y_^se1f2sx03(x)l2lbl#^5'
...
ROOT_URLCONF = 'franciosi_app.urls'
...
WSGI_APPLICATION = 'franciosi_app.wsgi.application'
...
STATICFILES_DIRS = [BASE_DIR/'franciosi_app'/'static']
